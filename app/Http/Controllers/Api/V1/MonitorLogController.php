...
/**
 * MonitorLogController handles the CRUD operations for MonitorLog.
 * It is basically the status of monitor task -> it has name MonitorLog and not status because
 * renaming all references from monitor_log to status would take a lot of time.
 */
